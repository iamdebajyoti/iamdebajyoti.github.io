...
path2 = r"C:\Users\ddutta8\OneDrive - DXC Production\Documents\DXC_Automation\Lalitha_Rakesh_Kumar__34235__BSL_pDXC_CMDB_Reconciliation\input files\BSL CMDB - June 30th.xlsx"
...
message = "BSL dump after cleaning duplicates .."
...
df_out_DXC = pd.merge(dxc_cmdb_df,bsl_cmdb_df[['bsl_name','bsl_install_status','bsl_sys_class_name','bsl_ip_address','bsl_model_id','bsl_location','bsl_manufacturer','bsl_ref_cmdb_ci_computer.os_version','bsl_ref_cmdb_ci_computer.cpu_count','bsl_ref_cmdb_ci_computer.ram']], how='left', left_on='dxc_name', right_on='bsl_name')
##,'bsl_serial_number'
...
df_out_DXC["Status_Matched_via_Mapping_Table"] = (df_out_DXC["dxc_install_status"] == df_out_DXC["DXC_Status_mapper"])
...
print(message, df_out_DXC.shape)
df_out_DXC = pd.merge(df_out_DXC,bsl_cmdb_df['bsl_serial_number'], how='left', left_on='dxc_serial_number', right_on='bsl_serial_number')#, suffixes=('','_Serial_Nums_Lookup_From_BSL'))
df_out_DXC.drop_duplicates(subset=["dxc_serial_number"], inplace=True, keep='first')
# print(df_out_DXC.info())
# #%%
df_out_DXC["Serials Match Status"] = (df_out_DXC["bsl_serial_number"] == df_out_DXC["bsl_serial_number"])
# df_out_DXC.rename(columns={'bsl_serial_number_Serial_Nums_Lookup_From_BSL':'Serial_Nums_Lookup_From_BSL'})
...
df_out_DXC.insert(7,'bsl_serial_number_',df_out_DXC['bsl_serial_number'])
df_out_DXC.insert(10,'bsl_install_status_',df_out_DXC['bsl_install_status'])
df_out_DXC.insert(11,'Install Status_Match',df_out_DXC['Status_Matched_via_Mapping_Table'])
...
df_out_DXC.insert(28,'bsl_ref_cmdb_ci_computer.os_version_',df_out_DXC['bsl_ref_cmdb_ci_computer.os_version'])
df_out_DXC.insert(31,'bsl_ref_cmdb_ci_computer.cpu_count_',df_out_DXC['bsl_ref_cmdb_ci_computer.cpu_count'])
df_out_DXC.insert(33,'bsl_ref_cmdb_ci_computer.ram_',df_out_DXC['bsl_ref_cmdb_ci_computer.ram'])
df_out_DXC.insert(35,'bsl_manufacturer_',df_out_DXC['bsl_manufacturer'])
df_out_DXC.insert(26,'DXC_loc_CITY_',df_out_DXC['DXC_loc_CITY'])
df_out_DXC.insert(27,'bsl_location_',df_out_DXC['bsl_location'])
df_out_DXC.insert(35,'BSL_loc_CITY_',df_out_DXC['BSL_loc_CITY'])
df_out_DXC.insert(36,'location_match_',df_out_DXC['location_match'])

df_out_DXC.drop(columns=['bsl_name','bsl_serial_number','bsl_install_status','Status_Matched_via_Mapping_Table','bsl_sys_class_name','bsl_ip_address','bsl_model_id','bsl_ref_cmdb_ci_computer.os_version','bsl_ref_cmdb_ci_computer.cpu_count','bsl_ref_cmdb_ci_computer.ram','bsl_manufacturer','bsl_location','DXC_loc_CITY','BSL_loc_CITY','location_match'],inplace=True)
# print(df_out_DXC.info())
message = "Done ..."
print(message, df_out_DXC.shape)
#%%
...
print(message)
print("{} class names found...".format(class_names))
# print('\n'.join(class_names))
...
#     message = "Created DXC output file ...."
#     print(message)
